...
import random
import shutil
from models.untils import FocalLoss, adjust_input
import importlib
...
def train_model(training_file='training_file',
    ...
    for epoch in range(n_epoch):
        ...
        validate_cost = rnn_tools.calculate_cost_tran(model, validate, options, max_len, focal_loss)
        test_cost = rnn_tools.calculate_cost_tran(model, test, options, max_len, focal_loss)
...
if __name__ == '__main__':
    ...
    use_gpu = True
    layer = 1
    model_choice = 'TransformerTimeMix'
