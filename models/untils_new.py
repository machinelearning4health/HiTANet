...
import rnn_tools, copy
import numpy as np
from models.transformer import EncoderNew as TrEncoder
from models.transformer import EncoderNT as TrEncoderNT
...
class PriorEncoder(nn.Module):
    ...
    def forward(self, seq_dignosis_codes, maxlen, final_queries, options, mask):
        ...
        #prior_weights = self.weight_layer(final_embeddings)
...
class Timeline(nn.Module):
    ...
    #sentence[2] time sentence sentence[0] code sentence sentence[1] mask
